...
Inadequate staff: As stated, fewer registrants worked on the first day of the event. The were differences among the registrants in terms of their effectiveness and this was found to be statistically significant.

```{r}
df %>% 
  ggplot(aes(fct_infreq(registrant), fill = ifelse(registrant == "Eventbrite", "Highlighted", "Normal"))) +
  geom_bar() + 
  coord_flip() +
  ggtitle("Performance of Registrants") +
